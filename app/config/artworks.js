export const ARTWORKS = {
  ...
  4: { src: '/art/season1/DeltaSauce_ghostboy.png', thumb:'/art/season1/optimized/DeltaSauce_ghostboy-320w.webp', artist: 'DeltaSauce', title: 'ghostboy', pfp:'/artist_pfp/DELTASAUCE.webp', twitter: 'delta_sauce', drops: 'Oct 21th', dropsUnix: '1761080400', width:'155', height: '277', soldOut: 'true' },
  5: { src: '/art/season1/Metageist_Synapse.mp4', poster:'/art/season1/optimized/Metageist_Synapse-poster-320w.webp', gif:'/art/season1/Metageist_Synapse.gif', artist: 'Metageist', title: 'Synapse', pfp:'/artist_pfp/METAGEIST.webp', twitter: 'MetageistVR', drops: 'Oct 28th', dropsUnix: '1761685200', width:'277', height: '277', soldOut: 'false' },
  ...
  7: { src: '/art/season1/VERDANDI_Token_Architect.mp4', poster:'/art/season1/optimized/VERDANDI_Token_Architect-poster-320w.webp', artist: 'VERDANDI', title: 'Token Architect', pfp:'/artist_pfp/VERDANDI.webp', twitter: 'TheVERDANDI', drops: 'Nov 11th', dropsUnix: '1762898400', width:'320', height: '213', soldOut: 'false' },
};

export const LATEST_CARD = 7;
