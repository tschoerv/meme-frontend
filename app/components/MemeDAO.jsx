    ...
    return (
        <section className="max-w-3xl mx-auto px-4 text-sm sm:text-base leading-relaxed">
            ...
            <ul className="list-disc list-inside space-y-0 mb-6">
                <li>
                    <strong>Open proposals in Discord:</strong> Anyone can suggest a marketing idea, campaign, or meme-related initiative directly in the community Discord.
                </li>
                <li>
