        ...
        <Tabs className="mb-3 custom-tabs">
          <Tab title="Season 1" className="mb-2">
            <Tabs defaultActiveTab={initialTitle} className="mb-2">
              ...
              <Tab title="Card 6" style={{ cursor: 'pointer' }}>
                <CardPanel id={6} isPaused={!!isPaused} anchorPos={anchorPos} />
              </Tab>

              <Tab title="Card 7" style={{ cursor: 'pointer' }}>
                <CardPanel id={7} isPaused={!!isPaused} anchorPos={anchorPos} />
              </Tab>
